        ...
        <Grid container sx={{ mt: {xs: 6, sm: 8, md: 8, lg: 8 },}}>
          ...
          <Grid container sx={{ mt: { xs: 40, sm: 42, md: 45, lg: 48}}}>
            ...
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, m: {xs: 1, sm: 2, md: 3, lg: 5}, ml: 2, mr: 2}}>
              このページではGenius Chickenのコンセプトや技術的な趣旨、開発時の問題点等をまとめてみました。
            </Box>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6} md={5} lg={4}>
          ...
          <Grid item xs={12} sm={6} md={7} lg={8} sx={{  mt: {xs: 1, sm: 2, md: 5, lg: 7}, bgcolor: "rgba(176,151,097,0.8)"}}>
            ...
            <Box sx={{ textAlign: "center", fontFamily: "serif", fontSize: { xs: 18, sm: 22, md: 26, lg: 30}}}>CONSEPT</Box>
            </Box>
          ...
          <Grid item xs={12} sm={6} md={7} lg={8} sx={{  mt: {xs: 1, sm: 2, md: 5, lg: 7}, bgcolor: "rgba(176,151,097,0.8)"}}>
            ...
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 1, sm: 1, md: 2, lg: 2}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
              1:モダンな技術を取り入れつつ、自分とインターン先との技術的なマッチ度を上げるため。
            </Box>
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 1, sm: 1, md: 2, lg: 2}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
              2:リッチなUIを提供できるreactと汎用性が高くrailsに似ているdjangoとの組み合わせでアプリを作ってみたかったから。
             （結局djangoではなくfast apiでも良かったなと思いました。）
            </Box>
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 1, sm: 1, md: 2, lg: 2}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
              3:これらの複数環境をコマンド1つで同時に立ち上げ、楽に管理するためにDockerを取り入れた。
            </Box>
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 1, sm: 1, md: 2, lg: 2}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
