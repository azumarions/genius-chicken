...
const ProfilePage: NextPage = () => {
    ...
    useIntersectionObserver([ref30, ref31, ref32, ref33, ref34, ref35, ref36, ref37, ref38, ref39], showElements)
        ...
        <Grid container sx={{ mt: {xs: 6, sm: 8, md: 8, lg: 8 },}}>
          <Grid container sx={{ position: "fixed", zIndex: -1}}>
            <Grid item xs={12} sm={6} md={5} lg={4}>
                ...
                <Image src="/home6.png" width={500} height={700} alt="home_image" sizes="100vw" style={{ width: '100%', height: 'auto',}} />
                </Box>
            </Grid>
          ...
          <Grid container sx={{ mt: { xs: 40, sm: 42, md: 45, lg: 48}}}>
            ...
            <Grid item xs={12} sm={6} md={7} lg={8} sx={{  mt: {xs: 1, sm: 2, md: 5, lg: 7}, bgcolor: "rgba(176,151,097,0.8)"}}>
            <Box className={styles.heading} ref={ref30}>
            <Box sx={{ textAlign: "center", fontFamily: "serif", fontSize: { xs: 18, sm: 22, md: 26, lg: 30}}}>OVERVIEW</Box>
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, m: {xs: 1, sm: 2, md: 3, lg: 5}, ml: 2, mr: 2}}>
          ...
          <Grid item xs={12} sm={6} md={7} lg={8} sx={{  mt: {xs: 1, sm: 2, md: 5, lg: 7}, bgcolor: "rgba(176,151,097,0.8)"}}>
            ...
            <Box sx={{ textAlign: "center", fontFamily: "serif", fontSize: { xs: 18, sm: 22, md: 26, lg: 30}}}>SELF-INTRODUCTION</Box>
            </Box>
            <Box className={styles.heading} ref={ref32}>
            <Box sx={{ textAlign: "center", display: 'flex', flexDirection: 'column', alignItems: 'center',}}>
              <Avatar sx={{ textAlign: "center", m: 1, width: 130, height: 130 }} src="/profile_image2.png" alt="profile"></Avatar>
            </Box>
          ...
          <Grid item xs={12} sm={6} md={7} lg={8} sx={{  mt: {xs: 1, sm: 2, md: 5, lg: 7}, bgcolor: "rgba(176,151,097,0.8)"}}>
            ...
            <Box sx={{ textAlign: "center", fontFamily: "serif", fontSize: { xs: 18, sm: 22, md: 26, lg: 30}}}>TECHNOLOGY</Box>
            </Box>
          ...
          <Grid item xs={12} sm={6} md={7} lg={8} sx={{  mt: {xs: 1, sm: 2, md: 5, lg: 7}, bgcolor: "rgba(176,151,097,0.8)"}}>
            ...
            <Box sx={{ textAlign: "center", fontFamily: "serif", fontSize: { xs: 18, sm: 22, md: 26, lg: 30}}}>SOCIAL MEDIA</Box>
            </Box>
            ...
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 2, sm: 2, md: 4, lg: 4}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
              <IconButton href='https://github.com/azumarions/'><GitHubIcon /></IconButton>
            </Box>
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 2, sm: 2, md: 4, lg: 4}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
              instagram
            </Box>
            <Box sx={{ fontFamily: "serif", fontSize: { xs: 12, sm: 14, md: 16, lg: 18}, mt: {xs: 2, sm: 2, md: 4, lg: 4}, ml: {xs: 2, sm: 3, md: 4, lg: 5}, mr:{ xs: 2, sm: 3, md: 4, lg: 5}}}>
              <IconButton href='https://www.instagram.com/azumarions/'><InstagramIcon /></IconButton>
            </Box>
            </Box>
          </Grid>
          </Grid>
