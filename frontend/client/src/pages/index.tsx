    ...
    <>
      <Box>
        <Grid
          container
          sx={{
            mt: { xs: 6, sm: 8, md: 8, lg: 8 },
            bgcolor: 'rgba(176,151,097,0.5)',
          }}
        >
          <Grid
            item
        ...
        <Grid
          container
          sx={{ mt: 3, mb: 2, position: 'sticky', top: '30%', zIndex: -1 }}
        >
          ...
          >
            <Box
              sx={{
                ...
                mt: 3,
                fontFamily: 'serif',
                fontSize: { xs: 18, sm: 20, md: 24, lg: 30 },
                m: 1,
              }}
            >
              複雑性を排除する
            ...
            <Box className={styles.heading} ref={ref4}>
              ...
              >
                <Button
                  ...
                  variant="outlined"
                  color="success"
                  sx={{ pl: 10, pr: 10, fontFamily: 'serif' }}
                >
                  ABOUT
                </Button>
              </Box>
